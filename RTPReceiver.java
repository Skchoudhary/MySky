...
public RTPReceiver(String remoteIPAddress, int remotePort, int localPort)
{
...
//	System.exit(0);
//     }
    RTPReceiver  recv = new RTPReceiver("172.16.7.95", 12000, 11000 );
