...
public class RTPReceiverAudioWithPanel implements Runnable {
...
public RTPReceiverAudioWithPanel(String remoteIPAddress, int remotePort, int localPort,JPanel jp)
{
